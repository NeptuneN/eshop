...
CREATE TABLE public.products (
    ...
    category_id integer,
    on_frontpage boolean DEFAULT false,
    in_cart boolean DEFAULT false,
    description text DEFAULT 'Flopper'::text
);
...
ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_customer_foreign FOREIGN KEY (customer) REFERENCES public.customers(id) ON DELETE SET NULL;
ALTER TABLE ONLY public.orders
